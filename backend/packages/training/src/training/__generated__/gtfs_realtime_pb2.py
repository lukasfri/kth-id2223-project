...
_TRIPDESCRIPTOR_MODIFIEDTRIPSELECTOR = _TRIPDESCRIPTOR.nested_types_by_name['ModifiedTripSelector']
...
_TRIPMODIFICATIONS = DESCRIPTOR.message_types_by_name['TripModifications']
_TRIPMODIFICATIONS_MODIFICATION = _TRIPMODIFICATIONS.nested_types_by_name['Modification']
_TRIPMODIFICATIONS_SELECTEDTRIPS = _TRIPMODIFICATIONS.nested_types_by_name['SelectedTrips']
_STOPSELECTOR = DESCRIPTOR.message_types_by_name['StopSelector']
_REPLACEMENTSTOP = DESCRIPTOR.message_types_by_name['ReplacementStop']
_FEEDHEADER_INCREMENTALITY = _FEEDHEADER.enum_types_by_name['Incrementality']
_TRIPUPDATE_STOPTIMEUPDATE_STOPTIMEPROPERTIES_DROPOFFPICKUPTYPE = _TRIPUPDATE_STOPTIMEUPDATE_STOPTIMEPROPERTIES.enum_types_by_name['DropOffPickupType']
