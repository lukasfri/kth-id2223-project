...
pickle_file_path = f"{data_folder}/koda-static/static-data-{myDate.year:04d}-{myDate.month:02d}-{myDate.day:02d}.pkl"
if os.path.exists(pickle_file_path):
    ...
    static_data = StaticData.load_static_data(f"{data_folder}/koda-static/data-tmp", myDate)
    pickle.dump(static_data, open(pickle_file_path, "wb"))
    
@router.get("/routes/{route_short_name}")
